      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="./Index_Pegawai.php">Home</a></li>
            <li><a href="Profile_Pegawai.php">Profile Pegawai</a></li>
            <li><a href="Data_Gaji.php">Data Gaji</a></li>
            <li><a href="Simpanan_Pegawai.php">Simpanan Pegawai</a></li>
            <li><a href="Pinjaman_Pegawai.php">Pinjaman Pegawai</a></li>
          <!--   <li><a href="Data_Kehadiran.php">Data Kehadiran Pegawai</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="Cetak_Data_Golongan.php">Laporan Data Golongan</a></li>
                <li><a href="Cetak_Data_Jabatan.php">Laporan Data Jabatan</a></li>
                ...
                <li><a href="Cetak_Potongan_Gaji.php">Laporan Potongan Gaji</a></li> -->
              </ul>
            </li>
          </ul>
