...
<div class="container">
    <div class="row">
        <div class="box">
            <form class="form-horizontal" method="POST" action="{{ route('add_promo') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('promo_discount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="promo_discount" type="text" class="form-control" name="promo_discount" value="{{ old('promo_discount') }}">
